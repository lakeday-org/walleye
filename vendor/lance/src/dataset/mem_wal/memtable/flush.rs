...
pub struct MemTableFlusher {
    ...
    wal_backend: Option<Arc<dyn crate::dataset::mem_wal::WalBackend>>,
...
impl MemTableFlusher {
    ...
    /// Release backend replay buffers only after a generation's manifest commits.
    pub fn with_wal_backend(
        mut self,
        backend: Arc<dyn crate::dataset::mem_wal::WalBackend>,
    ) -> Self {
