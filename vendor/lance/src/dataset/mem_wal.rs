...
pub use memtable::flush::{CompactionResult, Compactor};
...
pub use wal::{
    BatchDurableWatcher, WalAppendResult, WalAppender, WalBackend, WalCommit, WalEntry,
    WalReadEntry, WalTailer, WalWrite, WalWriteResult,
};
